...
class Evaluator:
    ...
    def predict_on_dataset(self,
        ...
        for j in tr:
            # Generate batch.
            batch_X, batch_image_ids, batch_eval_neutral, batch_inverse_transforms, batch_orig_labels = next(generator) # moi lan lay batch_size hinh anh
            ...
            print('------------------------------y_pred filtered convert--------------------------------: ', y_pred[0].shape)
            # print('y_predddddddddddddd: ', y_pred)
            # print('test y_pred')
            # print(type(y_pred))
            # print(type(batch_X))
            # print(len(y_pred))
