...
def SSD(input_shape, num_classes,
    ...
    # x, pwconv5 = Conv(x, 512)
    # x, pwconv6 = Conv(x, 256)
    # x, pwconv7 = Conv(x, 256)
    ...
    conv9_2 = Conv2D(256, (2, 2), strides=(1, 1), activation='relu', padding='valid', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv9_2')(conv9_1)
