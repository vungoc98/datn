...
def SSD(image_size,
    ...
    print('------conv43 shape-------: ', conv4_3_norm_mbox_loc.shape)
    ...
    print('------fc7_mbox_loc shape-------: ', fc7_mbox_loc.shape)
    ...
    print('------conv6_2_mbox_loc shape-------: ', conv6_2_mbox_loc.shape)
    ...
    print('------conv7_2_mbox_loc shape-------: ', conv7_2_mbox_loc.shape)
    ...
    print('------conv8_2_mbox_loc shape-------: ', conv8_2_mbox_loc.shape)
    ...
    print('------conv9_2_mbox_loc shape-------: ', conv9_2_mbox_loc.shape)
    ...
    print('------conv10_2_mbox_loc shape-------: ', conv10_2_mbox_loc.shape)
